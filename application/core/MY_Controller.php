...
class MY_Controller extends CI_Controller {
	public function __construct() {
		...
		$this->school_name = 'Blooms \'n Daises';
	...
	public function web_header($title) {
		$data['title'] = $title;
		$data['school_name'] = $this->school_name;
		return $this->load->view('layout/web_header', $data);
	}
	...
	public function web_footer() {
		return $this->load->view('layout/web_footer');
	}


	public function login_footer() {
		return $this->load->view('layout/login_footer');
	}
