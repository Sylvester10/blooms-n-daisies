...
class Testimonial extends MY_Controller {
    ...
    public function create_testimonial() {
		...
		$this->form_validation->set_rules('url', 'Video Url', 'trim|required|is_unique[testimonials.url]',
			array(
	...
	public function edit_testimonial_action($testimonial_id) {
		$this->form_validation->set_rules('name', 'Name', 'trim|min_length[2]|max_length[500]');
		$this->form_validation->set_rules('testimony', 'Testimony', 'trim');
