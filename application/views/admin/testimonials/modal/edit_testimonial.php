				...
				<div class="modal-body">
					...
					echo form_open('testimonial/edit_testimonial_action/'.$t->id); ?>
						...
						<div class="form-group">
							...
							<br/>
							<input type="text" name="name" value="<?php echo set_value('name', $t->name); ?>" class="form-control"  />
						...
						<div class="form-group">
							...
							<br/>
							<textarea name="url" class="form-control"  ><?php echo $t->url; ?></textarea>
							<div class="form-error"><?php echo form_error('url'); ?></div>
						</div>
