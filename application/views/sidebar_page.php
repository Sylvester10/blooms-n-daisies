      ...
      <div class="full">
                  ...
                  <ul class="nav navbar-nav page-scroll navbar-right">
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           <li><a href="<?php echo base_url('home/blog_home'); ?>">Blog Home</a></li>
                           <li class="active"><a href="<?php echo base_url('home/blog_post'); ?>">Blog Post</a></li>
                           <li class="divider"></li>
                           <li><a href="index.html#latestblog">Latest Posts</a></li>
                        </ul>
                     </li>
                     <li><a href="<?php echo base_url('home/blog_post'); ?>">Register</a></li>
         ...
         <div id="page" class="container">
            ...
            <div class="single-page col-md-9">
               <!-- Content -->
               <h3>Information about our daycare</h3>
               ...
               <!-- Color Block -->  
               <div class="col-md-6">
                  <img src="img/service2.jpg" alt="" class="img-rounded img-responsive">
               </div>
               <div class="col-md-6">
